...
function npcHelp(): string {
  return [
    `🧙 **NPC Help** *(DM only)*`,
    ``,
    `NPC sheet commands use ${code("#NPC-name")} in place of ${code("@user")} in all standard commands.`,
    ``,
    `Manage NPC roster:`,
    ...
    `• ${code("!sheet #Brother Aldric")}`,
    `• ${code("!inv #Brother Aldric")}`,
    ``,
    `Edit stats — same as ${code("!char")}, add ${code("#Name")} at the end:`,
    `• ${code("!char set hp 40 #Brother Aldric")}`,
    `• ${code("!char set maxhp 40 #Brother Aldric")}`,
    `• ${code("!char adjust hp -12 #Brother Aldric")} — take damage`,
    `• ${code("!char set ability str ingame 18 #Brother Aldric")}`,
    `• ${code("!char set abilities ingame str 18 dex 14 con 16 #Brother Aldric")}`,
    `• ${code("!char set class Paladin #Brother Aldric")}`,
    `• ${code("!char set caster half #Brother Aldric")}`,
    `• ${code("!char set pb 3 #Brother Aldric")}`,
    `• ${code("!char set hd 10 #Brother Aldric")}`,
    `• ${code("!char prof skill Athletics #Brother Aldric")}`,
    `• ${code("!char prof save str #Brother Aldric")}`,
    ``,
    `Rests & experience:`,
    `• ${code("!rest long #Brother Aldric")}`,
    `• ${code("!rest short 2 #Brother Aldric")}`,
    `• ${code("!exp 500 #Brother Aldric")}`,
    ``,
    `Spells & inventory:`,
    `• ${code("!cast fireball 3 #Brother Aldric")}`,
    `• ${code("!spells add fireball #Brother Aldric")}`,
    `• ${code("!inv add Longsword #Brother Aldric")}`,
    `• ${code("!inv remove Longsword #Brother Aldric")}`,
    ``,
    `Reset sheet to default:`,
    `• ${code("!sheet reset #Brother Aldric")}`,
  ].join("\n");
}
